import { getSingleBlogForAdmin } from "@/components/actions/blogActions";
...
export default async function BlogDetailsPage({ params }: { params: Params }) {
    ...
    const blog = await getSingleBlogForAdmin(blogId);
    ...
    return (
        <div className="container mx-auto py-8 max-w-4xl">
            <div className="flex items-center justify-between mb-8">
                <Link href="/dashboard/manageblogs">
                ...
                <Link href={`/dashboard/manageblogs/update/${blog.id}`}>
                    <Button>
